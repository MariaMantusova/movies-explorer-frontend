    ...
    return (
        <section className="auth">
            ...
            <form className="auth__form" onSubmit={handleSubmitRegister}>
                ...
                <button disabled={!password.inputValid || !email.inputValid || !name.inputValid} className={`auth__button auth__button_type_login ${(!password.inputValid || !email.inputValid) && "auth__button_type_disabled"}`}>Зарегистрироваться</button>
            </form>
