    ...
    return (
        <section className="auth">
            ...
            <form className="auth__form" onSubmit={handleSubmitLogin}>
                ...
                <button disabled={!password.inputValid || !email.inputValid} className={`auth__button auth__button_type_login ${(!password.inputValid || !email.inputValid) && "auth__button_type_disabled"}`}>Войти</button>
            </form>
